...
public class SortByPrice {
	...
	public void testNGAsserts() throws Exception{
		...
		// ExtentReports
		ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("SortByPrice.html");
		ExtentReports extent = new ExtentReports();
		extent.attachReporter(htmlReporter);
		ExtentTest logStep = extent.createTest("SortByPrice", "Sort products by Price (low to high)");
    ...
    logStep.info("Step 4: Sort products by Price (low to high)");	
		driver.findElement(By.xpath("//*[@id='header_container']/div[2]/div[2]/span/select")).click();
		driver2.findElement(By.xpath("//*[@id='header_container']/div[2]/div[2]/span/select")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id='header_container']/div[2]/div[2]/span/select/option[3]")).click();
		driver2.findElement(By.xpath("//*[@id='header_container']/div[2]/div[2]/span/select/option[3]")).click();
		Thread.sleep(1000);
        String sortText = "PRICE (LOW TO HIGH)";
        String sortText2 = "PRICE (LOW TO HIGH)";
		String elementsortText = driver.findElement(By.xpath("//*[@id='header_container']/div[2]/div[2]/span/span")).getText();
		String elementsortText1 = driver2.findElement(By.xpath("//*[@id='header_container']/div[2]/div[2]/span/span")).getText();
        Assert.assertEquals(elementsortText, sortText);
        Assert.assertEquals(elementsortText1, sortText2);
        System.out.println(elementsortText);
        System.out.println(elementsortText1);
        logStep.pass("Products are sorted by Price (low to high)"); 
